...
CALL:checkEnvVarValid "LUX_X86_ILMBASE_ROOT"   || EXIT /b -1
CALL:checkEnvVarValid "LUX_X86_JPEG_ROOT"      || EXIT /b -1
CALL:checkEnvVarValid "LUX_X86_LIBPNG_ROOT"    || EXIT /b -1
CALL:checkEnvVarValid "LUX_X86_LIBTIFF_ROOT"   || EXIT /b -1
CALL:checkEnvVarValid "LUX_X86_OIIO_ROOT"      || EXIT /b -1
CALL:checkEnvVarValid "LUX_X86_OPENEXR_ROOT"   || EXIT /b -1
CALL:checkEnvVarValid "LUX_X86_OPENJPEG_ROOT"  || EXIT /b -1
...
IF %BUILD_CONFIGURATION%==Release copy python33.lib %LIB_DIR%
IF %BUILD_CONFIGURATION%==Release copy python33.dll %LIB_DIR%
IF %BUILD_CONFIGURATION%==Debug   copy python33_d.lib %LIB_DIR%
IF %BUILD_CONFIGURATION%==Debug   copy python33_d.dll %LIB_DIR%
