...
rem set SSE_VER=SSE1
rem set OCL_VER=NoOpenCL
rem set REL_DIR="\Release SSE1"
rem call :Install32
...
rem copy "%LUX_WINDOWS_BUILD_ROOT%"\Projects\luxrays\Win32\%SSE_VER%\%REL_DIR%\smallluxgpu2.exe .\ > nul
