...
IF %BUILD_DEBUG% EQU 1 ( msbuild /m /verbosity:minimal /property:"Configuration=Debug_Static" /property:"Platform=x64" /target:"Clean" /target:"freeglut" VisualStudio\2008\freeglut.sln )
msbuild /m /verbosity:minimal /property:"Configuration=Release_Static" /property:"Platform=x64" /target:"Clean" /target:"freeglut" VisualStudio\2008\freeglut.sln
...
IF %BUILD_DEBUG% EQU 1 ( msbuild /m /verbosity:minimal /property:"Configuration=Debug" /property:"Platform=x64" /target:"Clean" /target:"glew_static" build\vc6\glew.sln )
msbuild /m /verbosity:minimal /property:"Configuration=Release" /property:"Platform=x64" /target:"Clean" /target:"glew_static" build\vc6\glew.sln
